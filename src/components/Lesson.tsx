...
export function Lesson(props: LessonProps) {
    ...
    return (
        <Link to={`/event/lesson/${props.slug}`} className='group'>
            ...
            <div className={`rondeded border border-gray-500 p-4 mt-2 group-hover:border-green-500 transition-colors ${isActiveLesson ? 'bg-green-500' : ''}`}>
                <header className="flex items-center justify-between">
                    ...
                    <span className={`text-xs rounded px-2 by-[0.125rem] text-white border font-bold ${isActiveLesson ? "border-white" : "border-green-300 "}`}>
